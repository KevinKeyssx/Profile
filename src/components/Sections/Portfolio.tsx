...
const Portfolio: FC = memo((dataChildren) => {
	...
	return (
		<Section className="bg-neutral-800" sectionId={SectionId.Portfolio}>
			<div className="flex flex-col gap-y-8">
				<h2 className="self-center text-xl font-bold text-white">Mira algo de mi trabajo</h2>
				<div className=" w-full columns-2 md:columns-3 lg:columns-4">
				{portfolioItems( children as ILov[] ).map((item, index) => {
